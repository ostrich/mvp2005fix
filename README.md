...
For changes that have not reached a versioned release yet, download the [latest automated master build](https://github.com/ostrich/mvp2005fix/releases/tag/master-build).
